...
static void print_usage(const char* argv0) {
  std::cerr
      ...
      << "  --xover-pairs <int>             (maximum merge pairs checked; default env LSTAR_RPNI_XOVER_PAIRS or 50; 0 disables)\n"
      ...
      << "  --max-attempts <int>            (default: 500; -1 disables the limit)\n"
...
int main(int argc, char** argv) {
  try {
    ...
    for (int attempt = 0; opt.max_attempts < 0 || attempt < opt.max_attempts; attempt++) {
